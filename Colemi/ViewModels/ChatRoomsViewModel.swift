...
class ChatRoomsViewModel {
    ...
    private func updateUsersSimpleChatRoom(detailedChatRoomID: String) async {
        ...
        simpleChatRoomArray.append(SimpleChatRoom(id: detailedChatRoomID, receiverAvatarURL: "", latestMessage: "", receiverID: FakeUserData.shared.userTwoID, receiverName: "柏勳二號", latestMessageTime: Timestamp()))
        ...
        simpleChatRoomArray.append(SimpleChatRoom(id: detailedChatRoomID, receiverAvatarURL: "", latestMessage: "", receiverID: FakeUserData.shared.userOneID, receiverName: "柏勳一號", latestMessageTime: Timestamp()))
