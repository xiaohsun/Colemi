//
//  ThirdColorViewController.swift
//  Colemi
//
...
extension ThirdColorViewController: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension ThirdColorViewController: LobbyLayoutDelegate {
    func collectionView(
